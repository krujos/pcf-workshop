...
* Login with your THD email (all lowercase) and your production AMER password
...
`cf login -a https://api.run-at.homedepot.com -u <your email> -p <PR AMER password> -o <your org> -s development`
