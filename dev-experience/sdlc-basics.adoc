...
. Review the docs on link:http://docs.pivotal.io/pivotalcf/devguide/services/application-binding.html[Binding a Service Instance]
...
.. You should try to change it, just to prove to yourself that you can't. Only `admin` can change, create or apply security groups. Take a look at `cf create-security-group`.
