...
== Binding A test database to your development instance. 
...
----
. Repeat all the steps from the section above to push and bind a service for your `development` instance of `cities-service`
...
.. You can see what security groups are applied to your space with these commands: 
