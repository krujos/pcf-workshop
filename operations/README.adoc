...
You've also been provided a user account. Please login to the platform using your Home Depot email address (all lower case) and the password is your PR AMER password. Follow the prompts, and select the 'production' space. 
