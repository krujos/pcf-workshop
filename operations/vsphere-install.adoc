...
. Log into Ops Manager by going to `https://OPS-MGR-IP` and creating a user and password.  *Be sure to set the username and password supplied by the instructor*.
