...
. Log into Ops Manager by going to `https://192.168.5.3` from the JumpBox and creating a user and password.  *Be sure to set the username and password supplied by the instructor*.
